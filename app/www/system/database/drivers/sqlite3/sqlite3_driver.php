...
require_once dirname(__FILE__) . '/sqlite3_lt_php53.php';
/**
 * CodeIgniter
 *
...
class CI_DB_sqlite3_driver extends CI_DB {
	...
	function escape_str($str, $like = FALSE)
	{
		...
		$str = $this->conn_id->escapeString($str);
