<?php
/**
	This file breaks the standard of database table name is the name of the module.
	The reason for this is for ease of others developing modules for AirKey. They 
	don't have to memorize all the models. Just deal with one main one.
*/
